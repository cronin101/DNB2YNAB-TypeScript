...
/***/ function(module, exports, __webpack_require__) {
	...
	var transform_CSV = function (source, target) {
	    ...
	    var ynab_entries = dnb_entries.map(function (row) { return row.to_YNAB_entry(); });
	...
	var save_text_to_file = function (target, filename) {
	    ...
	    download_link.onclick = function (event) { return document.body.removeChild(event.target); };
	    download_link.click();
	};
	$(function () {
	    $('#transform').click(function () { return transform_CSV($('#source'), $('#target')); });
	    $('#download').click(function () { return save_text_to_file($('#target'), 'transactions.csv'); });
	});
